...
## 🗓️ Growth Timeline
- (**26.07 ~ Present**) - 뱅크샐러드 ax개발 인턴
- (**26.07 ~ Present**) - 오픈소스 컨트리뷰션 아카데미 (참여형 Node.js 파트)
- (**26.07 ~ Present**) - AUSG 10기
- (**25.06 ~ 25.02**) - 네이버 부스트캠프 (챌린지/베이직/멤버십)
- (**25.02 ~ 25.06**) - K2 KOREA ERP 전환 현장실습 
- (**24.09 ~ 24.12**) - GDGoC CUK 3기 (Java & Spring & 정보보안 스터디)
- (**24.01 ~ 24.06**) - ALCUK 8기 (알고리즘 소모임)
- (**23.03 ~ 23.06**) - UMC CUK 4기 (Spring 백엔드 스터디)
